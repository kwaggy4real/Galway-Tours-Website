...
public partial class Account_Views_View_Restaur_Pub : System.Web.UI.Page
{
        string idnumber;
        string Res_Pub;
        string address;
        ...
        public Account_Views_View_Restaur_Pub()
        {
            
        }
        public Account_Views_View_Restaur_Pub(string attractionName, string addr, string Webaddr, string info, string tel, string cat, string email)
        {
            this.Res_Pub = attractionName;
            address = addr;
            WebAddress = Webaddr;
            information = info;
            tel_num = tel;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string retrieveSql = @"Select Comp_Name from Details  Where UserId =" + "'" + Context.User.Identity.GetUserName() + "'" + " and Category = 'Restaurants/Pubs'"; ;
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                 ...
                 //   tel_num = System.Int32.Parse(tel);
                    ...
                    Account_Views_View_Restaur_Pub user1 = new Account_Views_View_Restaur_Pub(Res_Pub, address, WebAddress, information, tel_num, category, email);
                }
    ...
    {
        string retrieveSql = @"Delete from Details Where Comp_Name =" + "'" + Res_Pub + "'" + "and UserId =" + "'" + Context.User.Identity.GetUserName() + "'";
        ...
        try
        {
            ...
            Response.Redirect("~/Account/Views/View_Restaur_Pub.aspx");
