<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="View_Attractions.aspx.cs" Inherits="Account_Views_View_Attractions" %>
...
<link rel="stylesheet" href="~/Content/Site.css" type="text/css"/>
 ...
 <% if (User.Identity.IsAuthenticated == false)
    ...
    <nav>
     ...
     <div id="upload_content">
        ...
        <table>
            ...
            <tr>
                <td> <label>Name:</label><%= getAttractions().ToString() %><br /></td>
            </tr>
             <tr>
  ...
  <asp:ListView  runat="server"  ID="Repeater1"  GroupItemCount="5">
   ...
   <ItemTemplate>      
                     <td>   
                     <img src='<%# "View_Attractions.aspx?ImageID=" + Eval("id") %>' id="Image_Display"/>
