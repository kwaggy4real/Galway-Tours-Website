...
public partial class Account_Views_View_Hotel : System.Web.UI.Page
{
        string idnumber;
        string hotelName;
        string address;
        ...
        public Account_Views_View_Hotel()
        {
            
        }
        public Account_Views_View_Hotel(string attractionName, string addr, string Webaddr, string info, string tel, string cat, string email)
        {
            this.hotelName = attractionName;
            address = addr;
            WebAddress = Webaddr;
            information = info;
            tel_num = tel;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string retrieveSql = @"Select Comp_Name from Details  Where UserId =" + "'" + Context.User.Identity.GetUserName() + "'" + " and Category = 'Hotel'";;
    ...
    public void selectData()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    hotelName = (String)rdr["Comp_Name"];
                    ...
                    Account_Views_View_Hotel user1 = new Account_Views_View_Hotel(hotelName, address, WebAddress, information, tel_num, category, email);
                }
    ...
    {
        string retrieveSql = @"Delete from Details Where Comp_Name =" + "'" + hotelName + "'" + "and UserId =" + "'" + Context.User.Identity.GetUserName() + "'";
