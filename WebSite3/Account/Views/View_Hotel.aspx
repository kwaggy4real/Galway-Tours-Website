<%@ Page Title="View Hotel" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeFile="View_Hotel.aspx.cs" Inherits="Account_Views_View_Hotel" %>
...
<link rel="stylesheet" href="~/Content/Site.css" type="text/css"/>
    ...
    <nav>
     ...
     <div id="upload_content">
        ...
        <table>
            ...
            <tr>
                <td> <label> Telephone Number:</label> <%= getTel_num().ToString() %><br /></td>
            </tr>
            <tr>
        ...
        <p></p> <asp:Button ID="uploadImagebutton" Text="Edit Details" runat="server" CssClass="btn btn-default" OnClick="redirectEditDetails" /><br />
   ...
   <ItemTemplate>      
                     <td>   
                        <img src='<%# "View_Hotel.aspx?ImageID=" + Eval("id") %>' id="Image_Display"/>
          ...
          <p></p> <asp:Button Text="Upload Images" runat="server" CssClass="btn btn-default" OnClick="uploadImage" /><br /> 
             </div>   
             </div>         	
