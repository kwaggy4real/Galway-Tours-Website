<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="View_Restaur_Pub.aspx.cs" Inherits="Account_Views_View_Restaur_Pub" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <nav>
     ...
     <div id="upload_content">
        ...
        <table>
            ...
            <tr>
                <td> <label>Name:</label><%= getRes_Pub().ToString() %><br /></td>
            </tr>
             <tr>
 ...
 <asp:ListView  runat="server"  ID="Repeater1"  GroupItemCount="5">
   ...
   <ItemTemplate>      
                     <td>   
                       <img src='<%# "View_Restaur_Pub.aspx?ImageID=" + Eval("id") %>' id="Image_Display" />
