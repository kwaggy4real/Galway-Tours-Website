...
public partial class Account_Views_View_Hostels : System.Web.UI.Page
{
        string idnumber;
        string hostelName;
        string address;
        ...
        public Account_Views_View_Hostels()
        {
            
        }
        public Account_Views_View_Hostels(string attractionName, string addr, string Webaddr, string info, string tel, string cat, string email)
        {
            this.hostelName = attractionName;
            address = addr;
            WebAddress = Webaddr;
            information = info;
            tel_num = tel;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            string retrieveSql = @"Select Comp_Name from Details  Where UserId =" + "'" + Context.User.Identity.GetUserName() + "'" + " and Category = 'Hostels'";;
    ...
    public void selectData()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    hostelName = (String)rdr["Comp_Name"];
                ...
                //    tel_num = System.Int32.Parse(tel);
                    ...
                    Account_Views_View_Hostels user1 = new Account_Views_View_Hostels(hostelName, address, WebAddress, information, tel_num, category, email);
                }
            }
            catch (Exception es)
            {
    ...
    {
        string retrieveSql = @"Delete from Details Where Comp_Name =" + "'" + hostelName + "'" + "and UserId =" + "'" + Context.User.Identity.GetUserName() + "'";
        ...
        try
        {
            ...
            Response.Redirect("~/Account/Views/View_Hostels.aspx");
