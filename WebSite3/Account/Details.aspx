<%@ Page Title="Upload Information" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Details.aspx.cs" Inherits="Account_Details"  %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <nav>
    ...
    <h2><%: Title %></h2>
    <div><label>Business Name: </label><asp:TextBox id="Attraction_Name" runat="server" CssClass="form-control" Placeholder="e.g. Blue Skies Hotels" required="Please Enter a Name"/>  </div><br />
    ...
    <div><label>Telephone Number: </label><asp:TextBox TextMode="Number" id="Telephone_Number" runat="server" CssClass="form-control" Placeholder="098767663" /></div><br />
   ...
   <p></p> <asp:Button ID="submitdetails"  CssClass="btn btn-default"  OnClick="Submit" Text="Save" runat="server" />
